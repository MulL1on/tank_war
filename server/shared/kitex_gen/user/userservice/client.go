...
type Client interface {
	...
	GetUserInfoByToken(ctx context.Context, req *user.GetUserInfoByTokenReq, callOptions ...callopt.Option) (r *user.GetUserInfoByTokenResp, err error)
}
...
func (p *kUserServiceClient) GetUserInfoByToken(ctx context.Context, req *user.GetUserInfoByTokenReq, callOptions ...callopt.Option) (r *user.GetUserInfoByTokenResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetUserInfoByToken(ctx, req)
}
