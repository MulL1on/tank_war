...
type Room struct {
	...
	MaxPlayer     int32  `thrift:"max_player,3" frugal:"3,default,i32" json:"max_player"`
	CurrentPlayer int32  `thrift:"current_player,4" frugal:"4,default,i32" json:"current_player"`
...
func (p *Room) SetName(val string) {
	p.Name = val
}
func (p *Room) SetMaxPlayer(val int32) {
	p.MaxPlayer = val
}
func (p *Room) SetCurrentPlayer(val int32) {
	p.CurrentPlayer = val
}
func (p *Room) SetHost(val string) {
	p.Host = val
}
func (p *Room) SetPort(val int32) {
	p.Port = val
}
func (p *Room) SetRoomId(val int64) {
	p.RoomId = val
}
...
func (p *Room) DeepEqual(ano *Room) bool {
	...
	if !p.Field3DeepEqual(ano.MaxPlayer) {
		return false
	}
	if !p.Field4DeepEqual(ano.CurrentPlayer) {
		return false
	}
	...
	if !p.Field7DeepEqual(ano.RoomId) {
		return false
	}
	return true
}

func (p *Room) Field1DeepEqual(src string) bool {
...
func (p *Room) Field3DeepEqual(src int32) bool {
...
func (p *Room) Field4DeepEqual(src int32) bool {

	if p.CurrentPlayer != src {
		return false
	}
	return true
}
...
func (p *Room) Field6DeepEqual(src int32) bool {
...
func (p *Room) Field7DeepEqual(src int64) bool {
